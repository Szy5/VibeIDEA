...
export default function KnowledgeGraph() {
  ...
  useEffect(() => {
    ...
    const matched = GRAPH_DATA.nodes
      .filter((n) => n.label.toLowerCase().includes(q))
      .map((n) => n.id);
    const connectedEdges = GRAPH_DATA.edges.filter(
  ...
  return (
    ...
    >
      {/* Google Fonts */}
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Noto+Sans+SC:wght@300;400;500;600&family=JetBrains+Mono:wght@400;500&display=swap');
      ...
      >
        ...
        <div style={{ position: "relative", width: 240 }}>
          ...
          <input
            ...
            onFocus={(e) => (e.target.style.borderColor = "#6ee7f760")}
      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
        ...
        {selectedNode && (
          ...
          >
              ...
              <div>
                ...
                <div
                  style={{
                    ...
                    padding: "2px 8px",
                    borderRadius: 4,
                    background: TYPE_CONFIG[selectedNode.type].color + "20",
            ...
            <div style={{ borderTop: "1px solid #0f2942", paddingTop: 16 }}>
              <div
                style={{
                  color: "#475569",
                  fontSize: 11,
                  ...
                  <div
                    ...
                    onMouseEnter={(e) =>
                      (e.currentTarget.style.borderColor =
                        TYPE_CONFIG[conn.other.type].color + "60")
                    }
                    onMouseLeave={(e) =>
                      (e.currentTarget.style.borderColor = "#0f2942")
                    }
                  >
                    <div
                      style={{
            ...
            <div
              style={{
                marginTop: 16,
                borderTop: "1px solid #0f2942",
                paddingTop: 12,
              }}
            >
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <span style={{ color: "#334155", fontSize: 11 }}>节点大小</span>
                <span
                  style={{
                    color: "#475569",
                    fontSize: 11,
              ...
              >
                <span style={{ color: "#334155", fontSize: 11 }}>连接数</span>
                <span
                  style={{
                    color: "#475569",
                    fontSize: 11,
